...
class FileUtil
{
  ...
  public static final FILE_FILTER_XML:FileFilter = new FileFilter("XML Source File (.xml)", "*.xml");
...
class FileUtilSandboxed
{
  ...
  public static final FILE_EXTENSION_INFO_XML:FileDialogExtensionInfo = FileUtil.FILE_EXTENSION_INFO_XML;
