...
## [Unreleased]
### Overhauled
- Animation Editor (still a wip, working on actual stuff. `experimental` branch currently only has .xml files for the layout stuff or whatevers.)
### Enhanced
- [FileUtil additions + sandboxing](https://github.com/FunkinCrew/Funkin/pull/3032/)
